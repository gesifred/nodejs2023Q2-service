...
export class FavsService {
  ...
  async removeArtist(name: string, id: string) {
    const artist: Artist = await this.artistRepository
  ...
  async removeAlbum(name: string, id: string) {
    const album: Album = await this.albumRepository
  ...
  async removeTrack(name: string, id: string) {
    const track: Track = await this.trackRepository
